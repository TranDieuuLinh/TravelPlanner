...
class Qe {
    addListener(t, n) {
        const o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_class_private_field_get$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, _e)[t];
        return o === void 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_class_private_field_get$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, _e)[t] = [
            n
...
function xe(e) {
    ...
    var _Te_get;
    let { prevStyle: t, styleSheet: n } = (_Te_get = Te.get(e)) !== null && _Te_get !== void 0 ? _Te_get : {};
        ...
        case "hover":
            {
                const i = It({
                    ...
                    state: o.state
                }), s = "*, *:hover {cursor: ".concat(i, " !important; }");
                if (t === s) return;
...
function j(e, t, n) {
    ...
    F = new Map(F), F.set(e, t), it.emit("groupChange", {
        group: e,
        isUserInteraction: (n === null || n === void 0 ? void 0 : n.isUserInteraction) === !0,
        prev: o,
        next: t
    });
}
...
function At(e) {
    var _st;
    const t = getComputedStyle((_st = st(e)) !== null && _st !== void 0 ? _st : e).display;
...
function le(param) {
    let { delta: e, initialLayout: t, panelConstraints: n, pivotIndices: o, prevLayout: i, trigger: s } = param;
    if (k(e, 0)) return t;
            ...
            {
                {
                    ...
                    C(d, "Panel constraints not found for index ".concat(f));
                    const { collapsedSize: h = 0, collapsible: y, minSize: b = 0 } = d;
                    if (y) {
                        const v = a[f];
                        if (C(v != null, "Previous layout not found for panel index ".concat(f)), k(v, h)) {
                            const g = b - v;
                ...
                }
                {
                    ...
                    C(d, "No panel constraints found for index ".concat(f));
                    const { collapsedSize: h = 0, collapsible: y, minSize: b = 0 } = d;
                    if (y) {
                        const v = a[f];
                        if (C(v != null, "Previous layout not found for panel index ".concat(f)), k(v, b)) {
                            const g = v - h;
                            A(g, Math.abs(e)) > 0 && (e = e < 0 ? 0 - g : g);
                        }
                    }
    ...
    }
    {
        ...
        for(;;){
            const b = a[d];
            C(b != null, "Previous layout not found for panel index ".concat(d));
            const g = Z({
    ...
    }
    {
        ...
        for(; d >= 0 && d < n.length;){
            ...
            C(y != null, "Previous layout not found for panel index ".concat(d));
            const b = y - h, v = Z({
                overrideDisabledPanels: u,
                panelConstraints: n[d],
                prevSize: y,
    ...
    if ($t(r, l)) return i;
    {
        ...
        C(d != null, "Previous layout not found for panel index ".concat(f));
        const h = d + p, y = Z({
            overrideDisabledPanels: u,
        ...
        if (l[f] = y, !k(y, h)) {
            ...
            for(; g >= 0 && g < n.length;){
                const w = l[g];
                C(w != null, "Previous layout not found for panel index ".concat(g));
                const M = w + b, L = Z({
                    overrideDisabledPanels: u,
...
function K(param) {
    ...
    if (!k(i, 100) && o.length > 0) for(let a = 0; a < t.length; a++){
        const r = o[a];
        C(r != null, "No layout data found for index ".concat(a));
        const l = 100 / i * r;
        o[a] = l;
    }
    let s = 0;
...
function at(param) {
    ...
    const n = ()=>{
        ...
        let { nextSize: r, panels: l, prevLayout: c, derivedPanelConstraints: m } = param;
        const p = s(), S = l.findIndex((h)=>h.id === t), z = S === 0, f = S === l.length - 1;
        if (f && r < p && (z || l.slice(0, S).every((h, y)=>{
            const b = m[y];
            return (b === null || b === void 0 ? void 0 : b.collapsible) && k(b.collapsedSize, c[b.panelId]);
        }))) {
    ...
    return {
        ...
        expand: ()=>{
            ...
            if (r && p === l) {
                var _m_expandToSize;
                let S = (_m_expandToSize = m.expandToSize) !== null && _m_expandToSize !== void 0 ? _m_expandToSize : c;
                S === 0 && (S = 1), a(S);
            }
        },
        getSize: ()=>{
        ...
        case "Enter":
            {
                ...
                if (C(m, "Panel metadata not found"), m.collapsible) {
                    var _o_mutableState_expandedPanelSizes_c_id;
                    const p = u[c.id], S = m.collapsedSize === p ? (_o_mutableState_expandedPanelSizes_c_id = o.mutableState.expandedPanelSizes[c.id]) !== null && _o_mutableState_expandedPanelSizes_c_id !== void 0 ? _o_mutableState_expandedPanelSizes_c_id : m.minSize : m.collapsedSize;
                    U(t, S - p);
                }
                break;
            }
...
function ut(param) {
    let { document: e, event: t, hitRegions: n, initialLayoutMap: o, mountedGroups: i, pointerDownAtPoint: s, prevCursorFlags: u } = param;
    let a = 0;
    n.forEach((l)=>{
...
function Vt(param) {
    ...
    for (const m of e.panels){
        var _o_m_id;
        const p = (_o_m_id = o[m.id]) !== null && _o_m_id !== void 0 ? _o_m_id : 0;
    ...
    if (a.forEach((m, p)=>{
        ...
        var _o_m;
        const p = (_o_m = o[m]) !== null && _o_m !== void 0 ? _o_m : 0;
        c[m] = T(p / s * l);
    }
    else {
...
function Bt(e) {
    ...
    s.observe(e.element), e.panels.forEach((f)=>{
        C(!o.has(f.id), 'Panel ids must be unique; id "'.concat(f.id, '" was used more than once')), o.add(f.id), f.onResize && s.observe(f.element);
    });
    const u = ne({
        group: e
    }), a = ve(e), r = e.panels.map((param)=>{
        let { id: f } = param;
        return f;
    }).join(",");
    let l = e.mutableState.defaultLayout;
    l && (Ut(e.panels, l) || (l = void 0));
    var _e_mutableState_layouts_r, _ref;
    const c = (_ref = (_e_mutableState_layouts_r = e.mutableState.layouts[r]) !== null && _e_mutableState_layouts_r !== void 0 ? _e_mutableState_layouts_r : l) !== null && _ref !== void 0 ? _ref : We(a), m = K({
        layout: c,
        panelConstraints: a
    }), p = e.element.ownerDocument;
    var _J_get;
    J.set(p, ((_J_get = J.get(p)) !== null && _J_get !== void 0 ? _J_get : 0) + 1);
    ...
    return Ze(e).forEach((f)=>{
        ...
        C(!i.has(f.id), 'Separator ids must be unique; id "'.concat(f.id, '" was used more than once')), i.add(f.id), f.element.addEventListener("keydown", $e);
    }), J.get(p) === 1 && (p.addEventListener("contextmenu", Ge, !0), p.addEventListener("dblclick", _e1, !0), p.addEventListener("pointerdown", je, !0), p.addEventListener("pointerleave", He), p.addEventListener("pointermove", Ve), p.addEventListener("pointerout", Ue), p.addEventListener("pointerup", Be, !0)), function() {
        var _J_get;
        t = !1, J.set(p, Math.max(0, ((_J_get = J.get(p)) !== null && _J_get !== void 0 ? _J_get : 0) - 1)), kt(e), e.separators.forEach((d)=>{
            d.element.removeEventListener("keydown", $e);
        }), J.get(p) || (p.removeEventListener("contextmenu", Ge, !0), p.removeEventListener("dblclick", _e1, !0), p.removeEventListener("pointerdown", je, !0), p.removeEventListener("pointerleave", He), p.removeEventListener("pointermove", Ve), p.removeEventListener("pointerout", Ue), p.removeEventListener("pointerup", Be, !0)), s.disconnect();
    };
}
function Wt() {
...
function Xt(param) {
    let { children: e, className: t, defaultLayout: n, disableCursor: o, disabled: i, elementRef: s, groupRef: u, id: a, onLayoutChange: r, onLayoutChanged: l, orientation: c = "horizontal", resizeTargetMinimumSize: m = {
        coarse: 20,
        fine: 10
    }, style: p, ...S } = param;
    const z = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        ...
        W(z.current.onLayoutChange, x) || (z.current.onLayoutChange = x, r === null || r === void 0 ? void 0 : r(x));
    }), d = se((x, P)=>{
    ...
    const M = se((x, P)=>{
        ...
        if (E) {
            ...
            var _E_layout_P;
            return {
                flexGrow: (_E_layout_P = E.layout[P]) !== null && _E_layout_P !== void 0 ? _E_layout_P : 1,
                pointerEvents: D ? "none" : void 0
            };
        }
        if (n === null || n === void 0 ? void 0 : n[P]) return {
            flexGrow: n === null || n === void 0 ? void 0 : n[P]
        };
    }), L = Re({
        defaultLayout: n,
        disableCursor: o
            ...
            updateSeparatorProps: (x, param)=>{
                let { disabled: P, disableDoubleClick: I } = param;
    ...
    return q(()=>{
        ...
        const oe = Pe(h, (_)=>{
            ...
            R.mutableState.layouts[ft] = ce, Ee.forEach(($)=>{
                if ($.collapsible) {
                    var __prev;
                    const { layout: ge } = (__prev = _.prev) !== null && __prev !== void 0 ? __prev : {};
                    if (ge) {
...
function sn(param) {
    let { debounceSaveMs: e = 100, onlySaveAfterUserInteractions: t, panelIds: n, storage: o = localStorage, ...i } = param;
    const s = n !== void 0, u = "id" in i ? i.id : i.groupId, a = he(u, n !== null && n !== void 0 ? n : []), r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSyncExternalStore"])(Yt, ()=>o.getItem(a), ()=>o.getItem(a)), l = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (r) {
...
function Zt(param) {
    let { children: e, className: t, collapsedSize: n = "0%", collapsible: o = !1, defaultSize: i, disabled: s, elementRef: u, groupResizeBehavior: a = "preserve-relative-size", id: r, maxSize: l = "100%", minSize: c = "0%", onResize: m, panelRef: p, style: S, ...z } = param;
    const f = !!r, d = Le(r), h = Re({
        ...
        m === null || m === void 0 ? void 0 : m(R, r, D);
    });
    q(()=>{
        const R = y.current;
        if (R !== null) {
...
function tn(param) {
    let { children: e, className: t, disabled: n, disableDoubleClick: o, elementRef: i, id: s, style: u, ...a } = param;
    const r = Le(s), l = Re({
        disabled: n,
...
class Diff {
    diff(oldStr, newStr) {
        let // Type below is not accurate/complete - see above for full possibilities - but it compiles
...
"[project]/node_modules/diff/libesm/diff/character.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
class CharacterDiff extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
}
...
class WordDiff extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    ...
    tokenize(value) {
        ...
        if (options.intlSegmenter) {
            ...
            // function.
            parts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["segment"])(value, segmenter);
        } else {
...
function dedupeWhitespaceInChangeObjects(startKeep, deletion, insertion, endKeep, segmenter) {
    ...
    if (deletion && insertion) {
        const [oldWsPrefix, oldWsSuffix] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["leadingAndTrailingWs"])(deletion.value, segmenter);
        const [newWsPrefix, newWsSuffix] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["leadingAndTrailingWs"])(insertion.value, segmenter);
        if (startKeep) {
        ...
        // present.
        if (startKeep) {
            const ws = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["leadingWs"])(insertion.value, segmenter);
            insertion.value = insertion.value.substring(ws.length);
        }
        if (endKeep) {
            const ws = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["leadingWs"])(endKeep.value, segmenter);
            endKeep.value = endKeep.value.substring(ws.length);
        }
    // otherwise we've got a deletion and no insertion
    } else if (startKeep && endKeep) {
        const newWsFull = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["leadingWs"])(endKeep.value, segmenter), [delWsStart, delWsEnd] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["leadingAndTrailingWs"])(deletion.value, segmenter);
        ...
        const endKeepWsPrefix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["leadingWs"])(endKeep.value, segmenter);
        const deletionWsSuffix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trailingWs"])(deletion.value, segmenter);
        ...
        const startKeepWsSuffix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trailingWs"])(startKeep.value, segmenter);
        const deletionWsPrefix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["leadingWs"])(deletion.value, segmenter);
...
"[project]/node_modules/diff/libesm/diff/sentence.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class SentenceDiff extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    tokenize(value) {
        var _a;
...
"[project]/node_modules/diff/libesm/diff/css.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/base.js [app-client] (ecmascript)");
;
class CssDiff extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    tokenize(value) {
        return value.split(/([{}:;,]|\s+)/);
    }
}
...
"[project]/node_modules/diff/libesm/diff/json.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class JsonDiff extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    get useLongestToken() {
    ...
    constructor(){
        super(...arguments);
        this.tokenize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$line$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tokenize"];
    }
}
...
function canonicalize(obj, stack, replacementStack, replacer, key) {
    ...
    if (typeof obj === 'object' && obj !== null) {
        ...
        let key;
        for(key in obj){
            /* istanbul ignore else */ if (Object.prototype.hasOwnProperty.call(obj, key)) {
                sortedKeys.push(key);
            }
        }
        sortedKeys.sort();
...
"[project]/node_modules/diff/libesm/diff/array.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/base.js [app-client] (ecmascript)");
;
class ArrayDiff extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    tokenize(value) {
        return value.slice();
    }
    join(value) {
...
"[project]/node_modules/diff/libesm/patch/line-endings.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/diff/libesm/patch/parse.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function parsePatch(uniDiff) {
    ...
    function parseIndex() {
        ...
        if (index.oldFileName === undefined !== (index.newFileName === undefined)) {
            throw new Error('Missing ' + (index.oldFileName !== undefined ? '"+++ ..."' : '"--- ..."') + ' file header for ' + ((_a = index.oldFileName) !== null && _a !== void 0 ? _a : index.newFileName));
        }
        while(i < diffstr.length){
            const line = diffstr[i];
...
"[project]/node_modules/diff/libesm/util/distance-iterator.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function __TURBOPACK__default__export__(start, minLine, maxLine) {
...
"[project]/node_modules/diff/libesm/patch/apply.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/util/string.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$line$2d$endings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/patch/line-endings.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$parse$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/patch/parse.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$distance$2d$iterator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/util/distance-iterator.js [app-client] (ecmascript)");
;
;
;
;
function applyPatch(source, patch) {
    ...
    if (typeof patch === 'string') {
        patches = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$parse$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePatch"])(patch);
...
function applyStructuredPatch(source, patch) {
    ...
    if (options.autoConvertLineEndings || options.autoConvertLineEndings == null) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasOnlyWinLineEndings"])(source) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$line$2d$endings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isUnix"])(patch)) {
            patch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$line$2d$endings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unixToWin"])(patch);
        } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasOnlyUnixLineEndings"])(source) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$line$2d$endings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isWin"])(patch)) {
            patch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$line$2d$endings$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["winToUnix"])(patch);
        }
    }
     ...
     */ function applyHunk(hunkLines, toPos, maxErrors) {
        let hunkLinesI = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0, lastContextLineMatched = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : true, patchedLines = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : [], patchedLinesLength = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : 0;
    ...
    for(let i = 0; i < hunks.length; i++){
        ...
        for(let maxErrors = 0; maxErrors <= fuzzFactor; maxErrors++){
            ...
            const iterator = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$util$2f$distance$2d$iterator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(toPos, minLine, maxLine);
...
function applyPatches(uniDiff, options) {
    const spDiff = typeof uniDiff === 'string' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$parse$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePatch"])(uniDiff) : uniDiff;
    let currentIndex = 0;
...
"[project]/node_modules/diff/libesm/patch/reverse.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/diff/libesm/patch/create.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function structuredPatch(oldFileName, newFileName, oldStr, newStr, oldHeader, newHeader, options) {
    ...
    if (!optionsObj.callback) {
        return diffLinesResultToPatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$line$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["diffLines"])(oldStr, newStr, optionsObj));
    } else {
        const { callback } = optionsObj;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$line$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["diffLines"])(oldStr, newStr, Object.assign(Object.assign({}, optionsObj), {
            callback: (diff)=>{
...
"[project]/node_modules/diff/libesm/convert/dmp.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/diff/libesm/convert/xml.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/diff/libesm/index.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/base.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$character$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/character.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$line$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/line.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$sentence$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/sentence.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$css$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/css.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$json$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/json.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/array.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$apply$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/patch/apply.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$parse$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/patch/parse.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$reverse$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/patch/reverse.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$create$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/patch/create.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$convert$2f$dmp$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/convert/dmp.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$convert$2f$xml$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/convert/xml.js [app-client] (ecmascript)");
;
;
;
;
...
"[project]/node_modules/diff/libesm/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "Diff",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
    "FILE_HEADERS_ONLY",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$create$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FILE_HEADERS_ONLY"],
    "INCLUDE_HEADERS",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$create$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INCLUDE_HEADERS"],
    "OMIT_HEADERS",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$create$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OMIT_HEADERS"],
    "applyPatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$apply$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyPatch"],
    "applyPatches",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$apply$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyPatches"],
    "arrayDiff",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arrayDiff"],
    "canonicalize",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$json$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canonicalize"],
    "characterDiff",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$character$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["characterDiff"],
    "convertChangesToDMP",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$convert$2f$dmp$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertChangesToDMP"],
    "convertChangesToXML",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$convert$2f$xml$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertChangesToXML"],
    "createPatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$create$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPatch"],
    "createTwoFilesPatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$create$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTwoFilesPatch"],
    "cssDiff",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$css$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cssDiff"],
    "diffArrays",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["diffArrays"],
    "diffChars",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$character$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["diffChars"],
    "diffCss",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$css$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["diffCss"],
    "diffJson",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$json$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["diffJson"],
    "diffLines",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$line$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["diffLines"],
    "diffSentences",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$sentence$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["diffSentences"],
    "diffTrimmedLines",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$line$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["diffTrimmedLines"],
    "diffWords",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$word$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["diffWords"],
    "diffWordsWithSpace",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$word$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["diffWordsWithSpace"],
    "formatPatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$create$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatPatch"],
    "jsonDiff",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$json$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsonDiff"],
    "lineDiff",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$line$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lineDiff"],
    "parsePatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$parse$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePatch"],
    "reversePatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$reverse$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reversePatch"],
    "sentenceDiff",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$sentence$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sentenceDiff"],
    "structuredPatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$patch$2f$create$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["structuredPatch"],
    "wordDiff",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$word$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wordDiff"],
    "wordsWithSpaceDiff",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$word$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wordsWithSpaceDiff"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/index.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/base.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$character$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/character.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$word$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/word.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$diff$2f$line$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/diff/line.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/diff/libesm/index.js [app-client] (ecmascript)");
...
;
;
const jsDiff = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__;
var DiffType;
(function(DiffType) {
 ...
 */ function stringify(val, format) {
    if (format === 'yaml') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$yaml$2f$dist$2f$js$2d$yaml$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dump"](val, {
            indent: 2,
            lineWidth: -1,
            noRefs: true
        }).trimEnd();
 ...
 */ function structuralDiff(oldObj, newObj) {
 ...
 */ function structuralJsonStringDiff(oldJson, newJson) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.diffLines(oldJson, newJson, {
 ...
 */ function structuralYamlDiff(oldYaml, newYaml) {
    ...
    const oldObj = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$yaml$2f$dist$2f$js$2d$yaml$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["load"](oldYaml);
    const newObj = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$yaml$2f$dist$2f$js$2d$yaml$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["load"](newYaml);
    // Fast path: check if structurally identical by comparing serialized forms
    const oldNormalized = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$yaml$2f$dist$2f$js$2d$yaml$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dump"](oldObj, {
        indent: 2,
        lineWidth: -1,
        noRefs: true
    });
    const newNormalized = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$yaml$2f$dist$2f$js$2d$yaml$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dump"](newObj, {
        indent: 2,
        lineWidth: -1,
        noRefs: true
    });
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.diffLines(oldYaml, newYaml, {
        newlineIsToken: false
    });
}
/**
 ...
 */ function diffStructurally(oldVal, newVal, indent) {
    let format = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 'json';
    ...
    if (oldStr === newStr) {
        return [
            {
                value: reindent(oldStr, indent, format)
            }
        ];
    }
 ...
 */ function diffObjects(oldObj, newObj, indent) {
    let format = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 'json';
    const changes = [];
    ...
    for(let i = 0; i < allKeys.length; i++){
        ...
        if (inOld && inNew) {
            ...
            if (oldValStr === newValStr) {
                ...
                changes.push({
                    value: innerIndent + JSON.stringify(key) + ': ' + valueStr + comma + '\n'
                });
            } else {
 ...
 */ function diffArrays(oldArr, newArr, indent) {
    let format = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 'json';
    const changes = [];
    const indentStr = '  '.repeat(indent);
    const innerIndent = '  '.repeat(indent + 1);
    ...
    for(let i = 0; i < maxLen; i++){
        ...
        if (i >= oldArr.length) {
            ...
            changes.push({
                added: true,
                value: innerIndent + valueStr + comma + '\n'
            });
 ...
 */ function diffWithLines(oldStr, newStr, indent) {
    let _format = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 'json';
    ...
    const lineDiff = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.diffLines(oldIndented, newIndented);
 ...
 */ function reindent(str, indent) {
    let _format = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 'json';
 ...
 */ const computeDiff = function(oldValue, newValue) {
    let compareMethod = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : DiffMethod.CHARS;
    ...
    diffArray.forEach((param)=>{
        let { added, removed, value } = param;
        if (added) {
            computedDiff.right.push({
                type: DiffType.ADDED,
                value
            });
        } else if (removed) {
            computedDiff.left.push({
 ...
 */ const computeLineInformation = function(oldString, newString) {
    let disableWordDiff = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, lineCompareMethod = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : DiffMethod.CHARS, linesOffset = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 0, showLines = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : [], deferWordDiff = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : false;
    let diffArray = [];
    ...
    if (typeof oldString === "string" && typeof newString === "string") {
        ...
        if (lineCompareMethod === DiffMethod.JSON) {
            ...
            try {
                ...
                diffArray = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$diff$2f$libesm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.diffLines(oldString, newString, {
                    newlineIsToken: false
                });
            }
        } else {
    ...
    const getLineInformation = (value, diffIndex, added, removed, evaluateOnlyFirstLine)=>{
        ...
        return lines.map((line, lineIndex)=>{
                    ...
                    if (nextDiff === null || nextDiff === void 0 ? void 0 : nextDiff.added) {
                        ...
                        if (nextDiffLines) {
                            ...
                            if (left.value === rightValue) {
                                ...
                                const lineIsTooLong = line.length > MAX_LINE_LENGTH_FOR_WORD_DIFF || rightValue.length > MAX_LINE_LENGTH_FOR_WORD_DIFF;
            ...
            if ((showLines === null || showLines === void 0 ? void 0 : showLines.includes("L-".concat(left.lineNumber))) || (showLines === null || showLines === void 0 ? void 0 : showLines.includes("R-".concat(right.lineNumber))) && !diffLines.includes(counter)) {
                diffLines.push(counter);
            }
...
const getWorkerBlobUrl = async ()=>{
    ...
    try {
        const { WORKER_CODE } = await __turbopack_context__.A("[project]/node_modules/react-diff-viewer-continued/lib/esm/src/workerBundle.js [app-client] (ecmascript, async loader)");
        const blob = new Blob([
            WORKER_CODE
        ], {
...
const computeLineInformationWorker = async function(oldString, newString) {
    let disableWordDiff = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, lineCompareMethod = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : DiffMethod.CHARS, linesOffset = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 0, showLines = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : [], deferWordDiff = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : false, disableWorker = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : false;
...
;
const defaultLightThemeVariables = Object.freeze({
...
const defaultDarkThemeVariables = Object.freeze({
...
const __TURBOPACK__default__export__ = function(styleOverride) {
    let useDarkTheme = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, nonce = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "";
    ...
    const allExpandButton = css({
        ...
        ":focus": {
            outline: "1px ".concat(variables.addedGutterColor, " solid")
        }
    });
...
"[project]/node_modules/react-diff-viewer-continued/lib/esm/src/highlight-theme.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const defaultLightHighlightTheme = {
    default: "#24292e",
    comment: "#6a737d",
    prolog: "#6a737d",
    doctype: "#6a737d",
...
const defaultDarkHighlightTheme = {
    default: "#f8f8f2",
    comment: "#6272a4",
    prolog: "#6272a4",
    doctype: "#6272a4",
...
const resolveTokenColor = (theme, classNames)=>{
...
"[project]/node_modules/react-diff-viewer-continued/lib/esm/src/highlight.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2d$theme$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-diff-viewer-continued/lib/esm/src/highlight-theme.js [app-client] (ecmascript)");
;
;
;
;
 ...
 */ const LANGUAGE_LOADERS = {
    arduino: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/arduino.js [app-client] (ecmascript, async loader)"),
    bash: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/bash.js [app-client] (ecmascript, async loader)"),
    basic: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/basic.js [app-client] (ecmascript, async loader)"),
    c: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/c.js [app-client] (ecmascript, async loader)"),
    clike: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/clike.js [app-client] (ecmascript, async loader)"),
    cpp: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/cpp.js [app-client] (ecmascript, async loader)"),
    csharp: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/csharp.js [app-client] (ecmascript, async loader)"),
    css: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/css.js [app-client] (ecmascript, async loader)"),
    diff: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/diff.js [app-client] (ecmascript, async loader)"),
    go: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/go.js [app-client] (ecmascript, async loader)"),
    ini: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/ini.js [app-client] (ecmascript, async loader)"),
    java: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/java.js [app-client] (ecmascript, async loader)"),
    javascript: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/javascript.js [app-client] (ecmascript, async loader)"),
    json: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/json.js [app-client] (ecmascript, async loader)"),
    kotlin: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/kotlin.js [app-client] (ecmascript, async loader)"),
    less: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/less.js [app-client] (ecmascript, async loader)"),
    lua: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/lua.js [app-client] (ecmascript, async loader)"),
    makefile: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/makefile.js [app-client] (ecmascript, async loader)"),
    markdown: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/markdown.js [app-client] (ecmascript, async loader)"),
    markup: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/markup.js [app-client] (ecmascript, async loader)"),
    "markup-templating": ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/markup-templating.js [app-client] (ecmascript, async loader)"),
    objectivec: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/objectivec.js [app-client] (ecmascript, async loader)"),
    perl: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/perl.js [app-client] (ecmascript, async loader)"),
    php: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/php.js [app-client] (ecmascript, async loader)"),
    python: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/python.js [app-client] (ecmascript, async loader)"),
    r: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/r.js [app-client] (ecmascript, async loader)"),
    regex: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/regex.js [app-client] (ecmascript, async loader)"),
    ruby: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/ruby.js [app-client] (ecmascript, async loader)"),
    rust: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/rust.js [app-client] (ecmascript, async loader)"),
    sass: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/sass.js [app-client] (ecmascript, async loader)"),
    scss: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/scss.js [app-client] (ecmascript, async loader)"),
    sql: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/sql.js [app-client] (ecmascript, async loader)"),
    swift: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/swift.js [app-client] (ecmascript, async loader)"),
    typescript: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/typescript.js [app-client] (ecmascript, async loader)"),
    vbnet: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/vbnet.js [app-client] (ecmascript, async loader)"),
    yaml: ()=>__turbopack_context__.A("[project]/node_modules/refractor/lang/yaml.js [app-client] (ecmascript, async loader)")
};
/**
...
/** Languages we've tried and failed to load — never retried. */ const negativeCache = new Set();
/** In-flight loads, deduped so concurrent requests share one import. */ const inflight = new Map();
/** Resolve a requested language name to its canonical (registerable) key. */ const canonicalName = (language)=>{
    const requested = language.toLowerCase();
    var _LANGUAGE_ALIASES_requested;
    return (_LANGUAGE_ALIASES_requested = LANGUAGE_ALIASES[requested]) !== null && _LANGUAGE_ALIASES_requested !== void 0 ? _LANGUAGE_ALIASES_requested : requested;
};
const ensureLanguage = async (language)=>{
    const canonical = canonicalName(language);
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$refractor$2f$lib$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["refractor"].registered(canonical)) return canonical;
    ...
    if (!load) {
        load = loader().then((mod)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$refractor$2f$lib$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["refractor"].register(mod.default);
        }).catch(()=>{
            negativeCache.add(canonical);
        }).finally(()=>{
    ...
    await load;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$refractor$2f$lib$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["refractor"].registered(canonical) ? canonical : null;
};
/**
 ...
 */ const collectLeaves = (nodes, theme, color, offset, out)=>{
    ...
    for (const node of nodes){
        if (node.type === "text") {
            var _node_value;
            const value = (_node_value = node.value) !== null && _node_value !== void 0 ? _node_value : "";
            if (value.length > 0) {
                out.push({
                    start: pos,
            ...
            const className = (_node_properties = node.properties) === null || _node_properties === void 0 ? void 0 : _node_properties.className;
            const nextColor = Array.isArray(className) ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2d$theme$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveTokenColor"])(theme, className) : color;
            pos = collectLeaves(node.children, theme, nextColor, pos, out);
        }
    }
    return pos;
};
/** Splits contiguous leaves into per-line token arrays, rebased to line-start. */ const tokensByLine = (leaves, lineCount)=>{
...
const highlightSide = (text, language, theme)=>{
    if (text.length === 0) return [];
    let root;
    try {
        root = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$refractor$2f$lib$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["refractor"].highlight(text, language);
    } catch (e) {
        return null;
    }
    const leaves = [];
    var _root_children;
    collectLeaves((_root_children = root.children) !== null && _root_children !== void 0 ? _root_children : [], theme, theme.default, 0, leaves);
    const lineCount = text.split("\n").length;
    return tokensByLine(leaves, lineCount);
};
const sliceLineTokens = (tokens, from)=>{
...
const renderAtom = (text, color, type, param, key)=>{
    let { styles, showHighlight } = param;
    const style = color ? {
        color
    } : undefined;
    if (type === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffType"].ADDED) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("ins", {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$classnames$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(styles.wordDiff, {
    ...
    if (type === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffType"].REMOVED) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("del", {
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$classnames$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(styles.wordDiff, {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("span", {
        className: styles.wordDiff,
        style: style,
        children: text
    }, key);
};
const mergeHighlightWithDiff = (bodyText, bodyTokens, diffArray, options)=>{
    const ranges = [];
    let pos = 0;
    for (const diff of diffArray){
        ...
        if (value.length > 0) {
            ...
            ranges.push({
                ...
                type: (_diff_type = diff.type) !== null && _diff_type !== void 0 ? _diff_type : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffType"].DEFAULT
            });
            pos += value.length;
        }
    }
    ...
    while(cur < total){
        ...
        out.push(renderAtom(bodyText.slice(cur, end), token === null || token === void 0 ? void 0 : token.color, range ? range.type : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffType"].DEFAULT, options, key++));
        cur = end;
        if (tokenEnd <= cur) ti += 1;
...
const renderHighlightedPlain = (bodyText, bodyTokens)=>{
    ...
    return bodyTokens.map((token, i)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("span", {
            style: {
                color: token.color
            },
            children: bodyText.slice(token.start, token.end)
        }, i));
};
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$hidden$2d$blocks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-diff-viewer-continued/lib/esm/src/compute-hidden-blocks.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-diff-viewer-continued/lib/esm/src/compute-lines.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$expand$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-diff-viewer-continued/lib/esm/src/expand.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$styles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-diff-viewer-continued/lib/esm/src/styles.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$fold$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-diff-viewer-continued/lib/esm/src/fold.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-diff-viewer-continued/lib/esm/src/highlight.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2d$theme$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-diff-viewer-continued/lib/esm/src/highlight-theme.js [app-client] (ecmascript)");
;
;
;
 ...
 */ function splitLeadingWhitespace(value) {
    ...
    if (Array.isArray(value)) {
        const chunks = value.map((chunk)=>({
                ...chunk
            }));
        let indent = "";
        let i = 0;
        for(; i < chunks.length; i++){
            const chunkValue = typeof chunks[i].value === "string" ? chunks[i].value : null;
            ...
            chunks[i] = {
                ...chunks[i],
                value: chunkValue.slice(match[0].length)
            };
            break;
        }
        return indent ? {
 ...
 */ function applyDiffToHighlightedHtml(html, diffArray, styles) {
    ...
    function getWrapper(type) {
        if (type === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffType"].ADDED) {
            return {
                open: '<ins class="'.concat(styles.wordDiff, " ").concat(styles.wordAdded, '">'),
                close: "</ins>"
            };
        }
        if (type === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffType"].REMOVED) {
            return {
                open: '<del class="'.concat(styles.wordDiff, " ").concat(styles.wordRemoved, '">'),
                close: "</del>"
            };
        }
        return {
            open: '<span class="'.concat(styles.wordDiff, '">'),
            close: "</span>"
        };
    }
...
class DiffViewer extends (_React_Component = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Component"]) {
    /**
     * Gets the height of the sticky header, if present.
     */ getStickyHeaderHeight() {
        var _this_stickyHeaderRef_current;
        return ((_this_stickyHeaderRef_current = this.stickyHeaderRef.current) === null || _this_stickyHeaderRef_current === void 0 ? void 0 : _this_stickyHeaderRef_current.offsetHeight) || 0;
    }
    /**
     ...
     */ buildCumulativeOffsets(lineInformation, lineBlocks, blocks, expandedBlocks, showDiffOnly, charWidth, columnWidth, splitView) {
        ...
        for(let i = 0; i < lineInformation.length; i++){
            ...
            const leftLen = ((_line_left = line.left) === null || _line_left === void 0 ? void 0 : _line_left.value) ? this.getTextLength(line.left.value) : 0;
            const rightLen = ((_line_right = line.right) === null || _line_right === void 0 ? void 0 : _line_right.value) ? this.getTextLength(line.right.value) : 0;
    ...
    componentDidUpdate(prevProps) {
        ...
        } else if (prevProps.highlightLanguage !== this.props.highlightLanguage || prevProps.highlightTheme !== this.props.highlightTheme || prevProps.useDarkTheme !== this.props.useDarkTheme) {
    ...
    constructor(props){
        super(props), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "styles", void 0), // Cache for on-demand word diff computation
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "wordDiffCache", new Map()), // Ensures the highlightLanguage/renderContent precedence warning fires once.
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "highlightPrecedenceWarned", false), // Refs for measuring content column width and character width
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "contentColumnRef", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRef"]()), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "charMeasureRef", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRef"]()), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "stickyHeaderRef", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRef"]()), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "resizeObserver", null), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "scrollDebounceTimer", null), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "lastRenderedRange", {
            start: 0,
            end: Infinity
        }), /**
     * Computes word diff on-demand for a line, with caching.
     * This is used when word diff was deferred during initial computation.
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "getWordDiffValues", (left, right, lineIndex)=>{
            if (!left || !right) {
                return {
                    leftValue: left === null || left === void 0 ? void 0 : left.value,
                    rightValue: right === null || right === void 0 ? void 0 : right.value
                };
            }
            ...
            const cacheKey = "".concat(lineIndex, "-").concat(left.rawValue, "-").concat(right.rawValue);
            let cached = this.wordDiffCache.get(cacheKey);
            if (!cached) {
                const compareMethod = this.props.compareMethod === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffMethod"].JSON || this.props.compareMethod === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffMethod"].YAML ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffMethod"].CHARS : this.props.compareMethod;
                const computed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeDiff"])(left.rawValue, right.rawValue, compareMethod);
                var _computed_left, _computed_right;
                cached = {
                    left: (_computed_left = computed.left) !== null && _computed_left !== void 0 ? _computed_left : [],
                    right: (_computed_right = computed.right) !== null && _computed_right !== void 0 ? _computed_right : []
                };
                this.wordDiffCache.set(cacheKey, cached);
            }
            return {
                leftValue: cached.left,
                rightValue: cached.right
            };
        }), /**
     * Resets code block expand to the initial stage. Will be exposed to the parent component via
     * refs.
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "resetCodeBlocks", ()=>{
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "onBlockExpand", (id)=>{
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "recalculateOffsets", ()=>{
            ...
            var _this_state_computedDiffResult_cacheKey;
            const { lineInformation, lineBlocks, blocks } = (_this_state_computedDiffResult_cacheKey = this.state.computedDiffResult[cacheKey]) !== null && _this_state_computedDiffResult_cacheKey !== void 0 ? _this_state_computedDiffResult_cacheKey : {};
            if (!lineInformation) return;
            var _this_props_showDiffOnly, _this_props_splitView;
            const offsets = this.buildCumulativeOffsets(lineInformation, lineBlocks, blocks, this.state.expandedBlocks, (_this_props_showDiffOnly = this.props.showDiffOnly) !== null && _this_props_showDiffOnly !== void 0 ? _this_props_showDiffOnly : true, charWidth, columnWidth, (_this_props_splitView = this.props.splitView) !== null && _this_props_splitView !== void 0 ? _this_props_splitView : true);
            this.setState({
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "shouldHighlightWordDiff", ()=>{
            const { compareMethod } = this.props;
            return compareMethod === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffMethod"].CHARS || compareMethod === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffMethod"].WORDS || compareMethod === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffMethod"].WORDS_WITH_SPACE || compareMethod === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffMethod"].JSON || compareMethod === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffMethod"].YAML;
        }), /**
     * Maps over the word diff and constructs the required React elements to show word diff.
     *
     * @param diffArray Word diff information derived from line information.
     * @param renderer Optional renderer to format diff words. Useful for syntax highlighting.
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "renderWordDiff", (diffArray, renderer)=>{
            ...
            if (renderer) {
                var _highlighted_props_dangerouslySetInnerHTML, _highlighted_props;
                ...
                const htmlContent = highlighted === null || highlighted === void 0 ? void 0 : (_highlighted_props = highlighted.props) === null || _highlighted_props === void 0 ? void 0 : (_highlighted_props_dangerouslySetInnerHTML = _highlighted_props.dangerouslySetInnerHTML) === null || _highlighted_props_dangerouslySetInnerHTML === void 0 ? void 0 : _highlighted_props_dangerouslySetInnerHTML.__html;
                if (typeof htmlContent === "string") {
                    ...
                    return [
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cloneElement"](highlighted, {
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "renderLine", (lineNumber, type, prefix, value, additionalLineNumber, additionalPrefix)=>{
            const lineNumberTemplate = "".concat(prefix, "-").concat(lineNumber);
            const additionalLineNumberTemplate = "".concat(additionalPrefix, "-").concat(additionalLineNumber);
            var _this_props_highlightLines;
            const highlightLines = (_this_props_highlightLines = this.props.highlightLines) !== null && _this_props_highlightLines !== void 0 ? _this_props_highlightLines : [];
            ...
            const highlightMap = this.state.highlightResult ? prefix === LineNumberPrefix.LEFT ? this.state.highlightResult.left : this.state.highlightResult.right : null;
            var _ref;
            const sideLineNumber = (_ref = lineNumber !== null && lineNumber !== void 0 ? lineNumber : additionalLineNumber) !== null && _ref !== void 0 ? _ref : undefined;
            const fullLineTokens = highlightMap && sideLineNumber != null ? highlightMap.get(sideLineNumber) : undefined;
            const bodyTokens = fullLineTokens ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sliceLineTokens"])(fullLineTokens, indent.length) : undefined;
            // Longest body we'll merge char-by-char before falling back to plain colour.
            const MAX_HIGHLIGHT_MERGE_LENGTH = 500;
            let content;
            if (bodyTokens) {
                if (hasWordDiff) {
                    const bodyText = rest.map((chunk)=>typeof chunk.value === "string" ? chunk.value : "").join("");
                    content = bodyText.length > MAX_HIGHLIGHT_MERGE_LENGTH ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["renderHighlightedPlain"])(bodyText, bodyTokens) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeHighlightWithDiff"])(bodyText, bodyTokens, rest, {
                        styles: {
                            wordDiff: this.styles.wordDiff,
                    ...
                    content = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["renderHighlightedPlain"])(rest, bodyTokens);
                } else {
                    content = rest;
                }
            } else if (hasWordDiff) {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: [
                    ...
                    this.props.renderGutter ? this.props.renderGutter({
                        ...
                        type: type !== null && type !== void 0 ? type : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DiffType"].DEFAULT,
                        prefix,
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("td", {
                        ...
                        onMouseDown: ()=>{
                            ...
                            for(let i = 0; i < rightElements.length; i++){
                                var _rightElements_i;
                                (_rightElements_i = rightElements[i]) === null || _rightElements_i === void 0 ? void 0 : _rightElements_i.classList.remove(this.styles.noSelect);
                            }
                            const leftElements = document.getElementsByClassName("left");
                            for(let i = 0; i < leftElements.length; i++){
                                var _leftElements_i;
                                (_leftElements_i = leftElements[i]) === null || _leftElements_i === void 0 ? void 0 : _leftElements_i.classList.remove(this.styles.noSelect);
                            }
                            const opposite = document.getElementsByClassName(prefix === LineNumberPrefix.LEFT ? "right" : "left");
                            for(let i = 0; i < opposite.length; i++){
                                var _opposite_i;
                                (_opposite_i = opposite[i]) === null || _opposite_i === void 0 ? void 0 : _opposite_i.classList.add(this.styles.noSelect);
                            }
                        },
                        title: added && !hasWordDiff ? "Added line" : removed && !hasWordDiff ? "Removed line" : undefined,
                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])(ElementType, {
                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$classnames$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(this.styles.contentText, this.styles.contentFlex),
                            children: [
                                indent ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("span", {
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "renderSplitView", (param, index)=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("tr", {
                ...
                children: [
                    this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, leftValue),
                    this.renderLine(right.lineNumber, right.type, LineNumberPrefix.RIGHT, rightValue)
                ]
            }, index);
        }), /**
     ...
     * @param index React key for the lines.
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "renderInlineView", (param, index)=>{
            let { left, right } = param;
            // Compute word diff on-demand if deferred
            const { leftValue, rightValue } = this.getWordDiffValues(left, right, index);
            let content;
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    children: [
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("tr", {
                            className: this.styles.line,
                            children: this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, leftValue, null)
                        }),
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("tr", {
                            className: this.styles.line,
                            children: this.renderLine(null, right.type, LineNumberPrefix.RIGHT, rightValue, right.lineNumber, LineNumberPrefix.RIGHT)
                        })
                    ]
                }, index);
            }
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "onBlockClickProxy", (id)=>()=>this.onBlockExpand(id)), /**
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "renderSkippedLineIndicator", (num, blockNumber, leftBlockLineNumber, rightBlockLineNumber)=>{
            ...
            const message = this.props.codeFoldMessageRenderer ? this.props.codeFoldMessageRenderer(num, leftBlockLineNumber, rightBlockLineNumber) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("span", {
                ...
                children: [
                    "@@ -",
                    leftBlockLineNumber - num,
                    ",",
                    num,
                    " +",
                    rightBlockLineNumber - num,
                    ",",
                    num,
                    " @@"
                ]
            ...
            const expandGutter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("td", {
     ...
     *
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "getMemoisedKey", ()=>{
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "memoisedCompute", async ()=>{
            var _this_props_infiniteLoading;
            ...
            const containerHeight = (_this_props_infiniteLoading = this.props.infiniteLoading) === null || _this_props_infiniteLoading === void 0 ? void 0 : _this_props_infiniteLoading.containerHeight;
            const containerHeightPx = containerHeight ? typeof containerHeight === 'number' ? containerHeight : parseInt(containerHeight, 10) || 0 : 0;
            const shouldDeferWordDiff = !disableWordDiff && !!this.props.infiniteLoading && containerHeightPx > 0 && containerHeightPx < 2000;
            const { lineInformation, diffLines } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$compute$2d$lines$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeLineInformationWorker"])(oldValue, newValue, disableWordDiff, compareMethod, linesOffset, this.props.alwaysShowLines, shouldDeferWordDiff, this.props.disableWorker);
            var _this_props_extraLinesSurroundingDiff;
            const rawExtraLines = (_this_props_extraLinesSurroundingDiff = this.props.extraLinesSurroundingDiff) !== null && _this_props_extraLinesSurroundingDiff !== void 0 ? _this_props_extraLinesSurroundingDiff : 3;
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "lineToText", (info)=>{
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "buildSideTokens", (lineInformation, side, language, theme)=>{
            const entries = [];
            for (const line of lineInformation){
                ...
                entries.push({
                    ...
                    text: this.lineToText(info)
                });
            }
            entries.sort((a, b)=>a.lineNumber - b.lineNumber);
            const result = new Map();
            if (entries.length === 0) return result;
            const perLine = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["highlightSide"])(entries.map((e)=>e.text).join("\n"), language, theme);
            if (!perLine) return result;
            for(let i = 0; i < entries.length; i++){
                var _perLine_i;
                result.set(entries[i].lineNumber, (_perLine_i = perLine[i]) !== null && _perLine_i !== void 0 ? _perLine_i : []);
            }
            return result;
        }), /**
     * Resolves the active highlight theme (built-in light/dark, with any
     * `highlightTheme` overrides merged on top).
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "resolveHighlightTheme", ()=>{
            const base = this.props.useDarkTheme ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2d$theme$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultDarkHighlightTheme"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2d$theme$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultLightHighlightTheme"];
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "updateHighlight", async ()=>{
            var _this_state_highlightResult, _process_env;
            const { highlightLanguage } = this.props;
            if (!highlightLanguage) {
                if (this.state.highlightResult) this.setState({
            ...
            var _this_props_useDarkTheme;
            const dark = (_this_props_useDarkTheme = this.props.useDarkTheme) !== null && _this_props_useDarkTheme !== void 0 ? _this_props_useDarkTheme : false;
            var _this_props_highlightTheme;
            const key = "".concat(diffKey, "::").concat(highlightLanguage, "::").concat(dark, "::").concat(JSON.stringify((_this_props_highlightTheme = this.props.highlightTheme) !== null && _this_props_highlightTheme !== void 0 ? _this_props_highlightTheme : null));
            if (((_this_state_highlightResult = this.state.highlightResult) === null || _this_state_highlightResult === void 0 ? void 0 : _this_state_highlightResult.key) === key) return;
            const canonical = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$diff$2d$viewer$2d$continued$2f$lib$2f$esm$2f$src$2f$highlight$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ensureLanguage"])(highlightLanguage);
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "onScroll", ()=>{
            const container = this.state.scrollableContainerRef.current;
            ...
            const newStartRow = cumulativeOffsets ? this.findLineAtOffset(contentScrollTop, cumulativeOffsets) : Math.floor(contentScrollTop / DiffViewer.ESTIMATED_ROW_HEIGHT);
     ...
     */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "renderDiff", ()=>{
            var _scrollableContainerRef_current, _scrollableContainerRef_current1;
            ...
            const cacheKey = this.getMemoisedKey();
            var _computedDiffResult_cacheKey;
            const { lineInformation = [], lineBlocks = [], blocks = [] } = (_computedDiffResult_cacheKey = computedDiffResult[cacheKey]) !== null && _computedDiffResult_cacheKey !== void 0 ? _computedDiffResult_cacheKey : {};
            // Calculate visible range for virtualization
            let visibleRowStart = 0;
            let visibleRowEnd = Infinity;
            var _infiniteLoading_overscan;
            const buffer = (_infiniteLoading_overscan = infiniteLoading === null || infiniteLoading === void 0 ? void 0 : infiniteLoading.overscan) !== null && _infiniteLoading_overscan !== void 0 ? _infiniteLoading_overscan : 20;
            ...
            for(let lineIndex = 0; lineIndex < lineInformation.length; lineIndex++){
                ...
                if (!firstVisibleFound) {
                    topPadding = cumulativeOffsets ? cumulativeOffsets[rowIndex] || 0 : rowIndex * DiffViewer.ESTIMATED_ROW_HEIGHT;
                ...
                if (showDiffOnly) {
                    ...
                    if (blockIndex !== undefined) {
                        ...
                        if (!expandedBlocks.includes(blockIndex) && lastLineOfBlock) {
                            var _line_left_lineNumber, _line_right_lineNumber;
                            diffNodes.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                children: this.renderSkippedLineIndicator(blocks[blockIndex].lines, blockIndex, (_line_left_lineNumber = line.left.lineNumber) !== null && _line_left_lineNumber !== void 0 ? _line_left_lineNumber : 0, (_line_right_lineNumber = line.right.lineNumber) !== null && _line_right_lineNumber !== void 0 ? _line_right_lineNumber : 0)
                            }, lineIndex));
                            continue;
                        }
                        if (!expandedBlocks.includes(blockIndex)) {
                ...
                diffNodes.push(splitView ? this.renderSplitView(line, lineIndex) : this.renderInlineView(line, lineIndex));
            }
            // Calculate total content height
            const totalContentHeight = cumulativeOffsets ? cumulativeOffsets[cumulativeOffsets.length - 1] || 0 : totalRenderedRows * DiffViewer.ESTIMATED_ROW_HEIGHT;
            ...
            var _cumulativeOffsets_length, _scrollableContainerRef_current_scrollTop, _scrollableContainerRef_current_clientHeight;
            return {
                diffNodes,
                blocks,
                lineInformation,
                ...
                debug: {
                    ...
                    offsetsLength: (_cumulativeOffsets_length = cumulativeOffsets === null || cumulativeOffsets === void 0 ? void 0 : cumulativeOffsets.length) !== null && _cumulativeOffsets_length !== void 0 ? _cumulativeOffsets_length : 0,
                    renderedCount: diffNodes.length,
                    scrollTop: (_scrollableContainerRef_current_scrollTop = (_scrollableContainerRef_current = scrollableContainerRef.current) === null || _scrollableContainerRef_current === void 0 ? void 0 : _scrollableContainerRef_current.scrollTop) !== null && _scrollableContainerRef_current_scrollTop !== void 0 ? _scrollableContainerRef_current_scrollTop : 0,
                    ...
                    clientHeight: (_scrollableContainerRef_current_clientHeight = (_scrollableContainerRef_current1 = scrollableContainerRef.current) === null || _scrollableContainerRef_current1 === void 0 ? void 0 : _scrollableContainerRef_current1.clientHeight) !== null && _scrollableContainerRef_current_clientHeight !== void 0 ? _scrollableContainerRef_current_clientHeight : 0
                }
            };
            ...
            var _this_state_contentColumnWidth, _this_state_charWidth, _this_state_cumulativeOffsets_nodes_debug_visibleRowEnd, _this_state_cumulativeOffsets_, _this_state_cumulativeOffsets_nodes_debug_totalRows, _this_state_scrollableContainerRef_current, _this_state_scrollableContainerRef_current1;
            ...
            var _this_props_styles;
            this.styles = this.computeStyles((_this_props_styles = this.props.styles) !== null && _this_props_styles !== void 0 ? _this_props_styles : {}, useDarkTheme !== null && useDarkTheme !== void 0 ? useDarkTheme : false, nonce !== null && nonce !== void 0 ? nonce : "");
            ...
            const tableElement = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("table", {
                ...
                onMouseUp: ()=>{},
                children: [
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("colgroup", {
                        children: [
                            !this.props.hideLineNumbers && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("col", {
                                width: "50px"
                            }),
                            !splitView && !this.props.hideLineNumbers && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("col", {
                                width: "50px"
                            }),
                            this.props.renderGutter && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("col", {
                                width: "50px"
                            }),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("col", {
                                width: "28px"
                            }),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("col", {
                                width: "auto"
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("tbody", {
                        children: nodes.diffNodes
                    })
                ]
            });
            const showLoadingOverlay = (this.state.isLoading || this.state.isScrolling) && !!LoadingElement;
            var _this_state_contentColumnWidth_toFixed, _this_state_charWidth_toFixed, _this_state_cumulativeOffsets_nodes_debug_visibleRowEnd_toFixed, _this_state_cumulativeOffsets__toFixed, _this_state_cumulativeOffsets_nodes_debug_totalRows_toFixed, _this_state_scrollableContainerRef_current_scrollHeight, _this_state_scrollableContainerRef_current_scrollHeight1;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                ...
                children: [
                    showLoadingOverlay && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("div", {
                        style: {
                            position: 'absolute',
                            top: 0,
                            left: 0,
                        ...
                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(LoadingElement, {})
                    }),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                        ...
                        children: [
                            (!this.props.hideSummary || leftTitle || rightTitle) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                ref: this.stickyHeaderRef,
                                className: this.styles.stickyHeader,
                                children: [
                                    !this.props.hideSummary && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                    ...
                                    (leftTitle || rightTitle) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                        ...
                                        children: [
                                            ...
                                            splitView && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("div", {
                                                className: this.styles.titleBlock,
                            ...
                            this.props.infiniteLoading ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("div", {
                                style: {
                            ...
                            this.props.infiniteLoading && this.props.showDebugInfo && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                style: {
                                    position: 'fixed',
                                    top: 10,
                                    right: 10,
                                ...
                                children: [
                                    ...
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                        children: [
                                            "scrollTop: ",
                                            nodes.debug.scrollTop
                                        ]
                                    }),
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                        children: [
                                            "headerHeight: ",
                                            nodes.debug.headerHeight
                                        ]
                                    }),
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                        children: [
                                            "contentScrollTop: ",
                                            nodes.debug.contentScrollTop
                                        ]
                                    }),
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                        children: [
                                            "clientHeight: ",
                                            nodes.debug.clientHeight
                                        ]
                                    }),
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                        style: {
                                        ...
                                        children: [
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "visibleRowStart: ",
                                                    nodes.debug.visibleRowStart
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "visibleRowEnd: ",
                                                    nodes.debug.visibleRowEnd
                                                ]
                                            })
                                        ]
                                    }),
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                        ...
                                        children: [
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "totalRows: ",
                                                    nodes.debug.totalRows
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "offsetsLength: ",
                                                    nodes.debug.offsetsLength
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "renderedCount: ",
                                                    nodes.debug.renderedCount
                                                ]
                                            })
                                        ]
                                    }),
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                        ...
                                        children: [
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "topPadding: ",
                                                    nodes.topPadding.toFixed(0)
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "bottomPadding: ",
                                                    nodes.bottomPadding.toFixed(0)
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "totalContentHeight: ",
                                                    nodes.totalContentHeight.toFixed(0)
                                                ]
                                            })
                                        ]
                                    }),
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                        ...
                                        children: [
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "cumulativeOffsets: ",
                                                    this.state.cumulativeOffsets ? 'SET' : 'NULL'
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "columnWidth: ",
                                                    (_this_state_contentColumnWidth_toFixed = (_this_state_contentColumnWidth = this.state.contentColumnWidth) === null || _this_state_contentColumnWidth === void 0 ? void 0 : _this_state_contentColumnWidth.toFixed(0)) !== null && _this_state_contentColumnWidth_toFixed !== void 0 ? _this_state_contentColumnWidth_toFixed : 'N/A',
                                                    "px"
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "charWidth: ",
                                                    (_this_state_charWidth_toFixed = (_this_state_charWidth = this.state.charWidth) === null || _this_state_charWidth === void 0 ? void 0 : _this_state_charWidth.toFixed(2)) !== null && _this_state_charWidth_toFixed !== void 0 ? _this_state_charWidth_toFixed : 'N/A',
                                                    "px"
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "charsPerRow: ",
                                                    this.state.contentColumnWidth && this.state.charWidth ? Math.floor(this.state.contentColumnWidth / this.state.charWidth) : 'N/A'
                                                ]
                                            })
                                        ]
                                    }),
                                    this.state.cumulativeOffsets && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                        style: {
                                            marginTop: '5px',
                                            borderTop: '1px solid #444',
                                            paddingTop: '5px',
                                        ...
                                        children: [
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    ...
                                                    nodes.debug.visibleRowEnd,
                                                    "]: ",
                                                    (_this_state_cumulativeOffsets_nodes_debug_visibleRowEnd_toFixed = (_this_state_cumulativeOffsets_nodes_debug_visibleRowEnd = this.state.cumulativeOffsets[nodes.debug.visibleRowEnd]) === null || _this_state_cumulativeOffsets_nodes_debug_visibleRowEnd === void 0 ? void 0 : _this_state_cumulativeOffsets_nodes_debug_visibleRowEnd.toFixed(0)) !== null && _this_state_cumulativeOffsets_nodes_debug_visibleRowEnd_toFixed !== void 0 ? _this_state_cumulativeOffsets_nodes_debug_visibleRowEnd_toFixed : 'N/A'
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "offsets[",
                                                    nodes.debug.totalRows - 1,
                                                    "]: ",
                                                    (_this_state_cumulativeOffsets__toFixed = (_this_state_cumulativeOffsets_ = this.state.cumulativeOffsets[nodes.debug.totalRows - 1]) === null || _this_state_cumulativeOffsets_ === void 0 ? void 0 : _this_state_cumulativeOffsets_.toFixed(0)) !== null && _this_state_cumulativeOffsets__toFixed !== void 0 ? _this_state_cumulativeOffsets__toFixed : 'N/A'
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    ...
                                                    nodes.debug.totalRows,
                                                    "]: ",
                                                    (_this_state_cumulativeOffsets_nodes_debug_totalRows_toFixed = (_this_state_cumulativeOffsets_nodes_debug_totalRows = this.state.cumulativeOffsets[nodes.debug.totalRows]) === null || _this_state_cumulativeOffsets_nodes_debug_totalRows === void 0 ? void 0 : _this_state_cumulativeOffsets_nodes_debug_totalRows.toFixed(0)) !== null && _this_state_cumulativeOffsets_nodes_debug_totalRows_toFixed !== void 0 ? _this_state_cumulativeOffsets_nodes_debug_totalRows_toFixed : 'N/A'
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                style: {
                                                ...
                                                children: [
                                                    "viewportEnd: ",
                                                    (nodes.debug.contentScrollTop + nodes.debug.clientHeight).toFixed(0)
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                style: {
                                                ...
                                                children: [
                                                    "scrollHeight: ",
                                                    (_this_state_scrollableContainerRef_current_scrollHeight = (_this_state_scrollableContainerRef_current = this.state.scrollableContainerRef.current) === null || _this_state_scrollableContainerRef_current === void 0 ? void 0 : _this_state_scrollableContainerRef_current.scrollHeight) !== null && _this_state_scrollableContainerRef_current_scrollHeight !== void 0 ? _this_state_scrollableContainerRef_current_scrollHeight : 'N/A'
                                                ]
                                            }),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                                                children: [
                                                    "maxScrollTop: ",
                                                    ((_this_state_scrollableContainerRef_current_scrollHeight1 = (_this_state_scrollableContainerRef_current1 = this.state.scrollableContainerRef.current) === null || _this_state_scrollableContainerRef_current1 === void 0 ? void 0 : _this_state_scrollableContainerRef_current1.scrollHeight) !== null && _this_state_scrollableContainerRef_current_scrollHeight1 !== void 0 ? _this_state_scrollableContainerRef_current_scrollHeight1 : 0) - nodes.debug.clientHeight
                                                ]
                                            })
                                        ]
                                    })
        ...
        this.state = {
            expandedBlocks: [],
            noSelect: undefined,
            scrollableContainerRef: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRef"](),
            computedDiffResult: {},
            isLoading: false,
            visibleStartRow: 0,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(DiffViewer, "defaultProps", {
    oldValue: "",
    newValue: "",
    splitView: true,
    highlightLines: [],
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(DiffViewer, "ESTIMATED_ROW_HEIGHT", 19);
...
//# sourceMappingURL=node_modules_b1651ff2._.js.map