...
const DETAIL_LABELS: Record<string, string> = {
  ...
  sourceAndUserPlaceCount: "Địa điểm URL / người dùng",
  resolvedRequiredExperienceCount: "Trải nghiệm đã xác định địa điểm",
  unresolvedRequiredExperienceCount: "Trải nghiệm cần xác minh",
  optionalSuggestionCount: "Gợi ý tính vào capacity",
  mandatoryCandidateCount: "Địa điểm bắt buộc",
  requestedDays: "Số ngày yêu cầu",
  selectedDays: "Số ngày sau phân bổ",
  daysLocked: "Số ngày đã khóa",
  unscheduledMandatoryCount: "Bắt buộc chưa xếp",
  matrixProvider: "Nguồn ma trận di chuyển",
