    ...
    >
      ...
      <div className="itineraryStops unscheduledPlaceList">
        {places.map((place, index) => {
          const key = [
            place.candidateId ?? place.placeId ?? place.name,
            index,
          ].join("-");
          ...
          const isFoodStop = categories.some(
            (value) => categoryFromPlaceType(value) === "food",
          );
          ...
          return (
            <div className="itineraryItemDragWrapper" key={key}>
              <article
                className={
                  "itineraryStop unscheduledPlaceStop " +
                  (isFoodStop
                    ? "itineraryStop--food"
                  ...
                  <div className="itineraryPlaceContent">
                    ...
                    <div className="itineraryPlaceQuickActions">
                      <div className="itineraryPlaceQuickActionMenu">
                        ...
                        {openMenuKey === key && onDismissPlace ? (
                          <div className="itineraryPlaceQuickActionPopup" role="menu">
                            <button
                      ...
                      {sourceLabel?.url ? (
                        <a
                          ...
                          className={
                            "itinerarySourceIconLink itinerarySourceIconLink--" +
                    ...
                    {place.address ? (
                      <p className="unscheduledPlaceAddress">{place.address}</p>
                    ) : null}
                    ...
                    {place.day != null || sourceActivity ? (
                      <p className="unscheduledPlaceContext">
                        {place.day != null ? "Ưu tiên Ngày " + place.day : null}
                        {place.day != null && sourceActivity ? " · " : null}
                        {sourceActivity}
                      </p>
                    ) : null}
                    {onDismissPlace ? (
