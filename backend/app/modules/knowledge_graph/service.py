    ...
    async def _extract(
        ...
        *,
        ...
        system_prompt = (
            ...
            "- Extract only concrete node types declared in schema, including Place, Activity, and Item descendants\n"
            "- Extract only relationships declared in ontology, including LOCATED_IN, ADJACENT_TO, "
            "PART_OF, OFFERS_ACTIVITY, SPECIAL_EXPERIENCE, INVOLVES_ITEM, "
            "OFFERS_ITEM, and TARGETS_PLACE\n"
