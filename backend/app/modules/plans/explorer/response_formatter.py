    ...
    async def format(
        ...
        *,
        ...
        system_prompt = (
            ...
            "A URL caption, sentence, list of multiple venues, city name, promotional call to action, or text containing several pin/list markers is not a place name. Return each specifically identified venue as its own candidate; omit any stop whose identity is unclear so PlaceSelector can supply a verified alternative. "
            "Never copy a full caption, transcript sentence, hashtag block, promotional text, generic travel advice, or an unsupported operational claim into candidate notes or sourceActivity. Keep sourceActivity under 140 characters and leave it null when no concise useful activity or visit tip is directly evidenced. "
