    ...
    def _analyze_batch(
        ...
        *,
        ...
        prompt = (
            ...
            "the source does not assign a day. Set timeHint to an empty string "
            "when it is not visible. Set activity to a concise Vietnamese summary "
            "of a useful place-specific creator tip, action, dish, viewpoint or "
            "timing detail only when visually evidenced; otherwise use an empty "
            "string. Never use activity merely to say visit/explore the place. "
