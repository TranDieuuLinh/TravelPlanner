...
from app.modules.plans.url_job_router import router as url_import_jobs_router
from app.modules.profiles.router import public_router as posts_router
...
api_router.include_router(url_import_jobs_router)
