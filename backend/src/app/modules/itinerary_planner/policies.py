...
IDEAL_INTER_STOP_WAIT_MINUTES = 5
LIGHT_INTER_STOP_WAIT_MINUTES = 15
STRONG_INTER_STOP_WAIT_MINUTES = 30
MAX_INTER_STOP_WAIT_MINUTES = 90
MAX_DRINK_DESSERTS_PER_DAY = 2
