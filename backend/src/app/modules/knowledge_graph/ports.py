...
class KnowledgeGraphStore(Protocol):
    ...
    async def update_relationship(self, entity_id: str, relationship_id: int, relationship: str, to_entity_id: str, source: str | None, recommendations: dict | list[dict] | None, *, from_entity_id: str | None = None) -> dict | None: ...
