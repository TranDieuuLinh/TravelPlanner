...
from app.modules.place_checker.planning.food_output import (
    SelectedFoodPlanningProjector,
    limit_food_pool,
)
from app.modules.place_checker.selection.food.anchor_coverage import (
    unpaired_activity_anchor_ids,
)
...
from app.modules.place_checker.planning.budget import (
    AdmCandidateBudgetEstimator,
    build_planner_budget,
)
from app.modules.place_checker.planning.eligibility import is_planner_eligible
from app.modules.place_checker.planning.category import (
    planner_category,
    planner_category_for_candidate,
)
from app.modules.place_checker.planning.exclusions import build_excluded_candidate
from app.modules.place_checker.planning.semantics import split_trip_preferences
from app.modules.place_checker.planning.place_projection import PlannerPlaceProjector
from app.modules.place_checker.planning.pool_normalization import (
...
from app.modules.place_checker.planning.projection import PlaceCheckerPlanningProjector
...
class PlaceCheckerPlannerOutputBuilder:
    ...
    def unpaired_activity_anchor_ids(self, result: PlaceCheckerResult) -> list[str]:
        """Return final TravelPlace/Entertainment anchors without nearby food."""
        places, food, entertainment, _ = self._candidate_pools(result)
        return unpaired_activity_anchor_ids(places, food, entertainment)
    ...
    def _candidate_pools(
        ...
        entertainment = select_entertainment_pool(
            ...
            drink_dessert_limit=drink_dessert_pool_target_for_days(
                result.trip_context.days
            ),
        )
