...
URL/direct-input identity provisional được tự chọn từ candidate tốt nhất và giữ
kèm `verification_status` cùng constraint xác minh. Trách nhiệm hiện tại của
FinalItineraryPlanner không đổi.
